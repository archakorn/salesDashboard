...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React3.useState(() => {
    if (noSsr && matchMedia) {
...
var maybeReactUseSyncExternalStore = React3["useSyncExternalStore"];
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = React3.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React3.useMemo(() => {
    if (noSsr && matchMedia) {
      return () => matchMedia(query).matches;
    }
  ...
  const [getSnapshot, subscribe] = React3.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded7 = ["cssVarPrefix", "shouldSkipGeneratingVar"];
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YAZU5ALV.js.map
